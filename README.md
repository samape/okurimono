...
# アプリケーションを作成した背景
自身が日頃から抱えていた課題である、「誰かへのプレゼント選びに悩んでしまい時間がかかってしまう。また、喜ばれるような凝ったプレゼントがなかなか見つけられない。」という悩みを解決したいと思ったことがきっかけである。この課題を分析すると、「様々な人とプレゼントに関する情報をシェアする場」があれば解決できると考えた。家族、友人、同僚など様々なタイプの人におすすめのプレゼント情報をシェアし、プレゼント候補をすぐに見つけられるWebアプリケーションを開発することにした。
